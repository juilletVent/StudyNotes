...
# 1. 临时将系统网关切换到 192.168.6.2
echo "步骤1: 临时切换网关到 192.168.6.2"
echo "当前路由表:"
route -n
...
{
  "registry-mirrors": ["http://192.168.6.21:8181"],
  "insecure-registries": ["192.168.6.21:8181"]
}
EOF
...
echo "route del default gw 192.168.6.2"
